...
class HouseTest < MiniTest::Test
  ...
  def test_it_can_retrieve_rooms_by_category
    ...
    expected = house.rooms_from_category(:bedroom)
  ...
  def test_rooms_by_sorted_area
    ...
    house.add_room(room_3)
    house.add_room(room_4)
    expected = house.rooms_by_sorted_area
    assert_equal expected, house.rooms_by_sorted_area
  end
end
